...
import (
	...
	"github.com/sample-crd/pkg/client/clientset/versioned/scheme"
...
func (c *SamplecrdV1Client) SampleCRDs(namespace string) SampleCRDInterface {
	return newSampleCRDs(c, namespace)
}
